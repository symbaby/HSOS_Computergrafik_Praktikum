...
bool Matrix::operator==(const Matrix &M) {
    ...
    return fabs(m00 - M.m00) <= Epsilon && fabs(m01 - M.m01) <= Epsilon && fabs(m02 - M.m02) <= Epsilon &&
           fabs(m03 - M.m03) <= Epsilon &&
           fabs(m10 - M.m10) <= Epsilon && fabs(m11 - M.m11) <= Epsilon && fabs(m12 - M.m12) <= Epsilon &&
           fabs(m13 - M.m13) <= Epsilon &&
           fabs(m20 - M.m20) <= Epsilon && fabs(m21 - M.m21) <= Epsilon && fabs(m22 - M.m22) <= Epsilon &&
           fabs(m23 - M.m23) <= Epsilon &&
           fabs(m30 - M.m30) <= Epsilon && fabs(m31 - M.m31) <= Epsilon && fabs(m32 - M.m32) <= Epsilon &&
           fabs(m33 - M.m33) <= Epsilon;
