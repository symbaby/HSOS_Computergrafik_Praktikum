...
Texture::Texture(unsigned int width, unsigned int height, unsigned char *data) : m_TextureID(0), m_pImage(NULL),
                                                                                 CurrentTextureUnit(0), Width(0),
                                                                                 Height(0) {
...
Texture::Texture(unsigned int width, unsigned int height, GLint InternalFormat, GLint Format, GLint ComponentSize,
                 GLint MinFilter, GLint MagFilter, GLint AddressMode, bool GenMipMaps)
        : m_TextureID(0), m_pImage(NULL), CurrentTextureUnit(0), Width(0), Height(0) {
    bool Result = create(width, height, InternalFormat, Format, ComponentSize, MinFilter, MagFilter, AddressMode,
                         GenMipMaps);
    if (!Result)
        throw std::exception();
    Width = width;
...
bool Texture::create(unsigned int width, unsigned int height, GLint InternalFormat, GLint Format, GLint ComponentSize,
                     GLint MinFilter, GLint MagFilter, GLint AddressMode, bool GenMipMaps) {
    release();
...
bool Texture::create(unsigned int width, unsigned int height, unsigned char *data, bool Channel16Bit) {
    release();
