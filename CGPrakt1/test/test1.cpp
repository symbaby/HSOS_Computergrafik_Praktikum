...
void Test1::vector() {
    ...
    TEST("Vector lengthSquared failed!", (a.X * a.X + a.Y * a.Y + a.Z * a.Z) - EPSILON <= a.lengthSquared() &&
                                         a.lengthSquared() <= (a.X * a.X + a.Y * a.Y + a.Z * a.Z) + EPSILON);

    TEST("Vector length failed!", sqrt(a.X * a.X + a.Y * a.Y + a.Z * a.Z) - EPSILON <= a.length() &&
                                  a.length() <= sqrt(a.X * a.X + a.Y * a.Y + a.Z * a.Z) + EPSILON);
    ...
    TEST("Vector normalize, operator* or dot product failed!",
         a.dot(b) <= 1.0f + EPSILON && a.dot(b) >= 1.0f - EPSILON);
    ...
    for (int i = 0; i < 1000; i++) {
        Vector vr((float) (rand() % 10000) - 5000.0f, (float) (rand() % 10000) - 5000.0f,
